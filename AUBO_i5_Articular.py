...
T = np.array([
  ...
  [np.deg2rad(-175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],        # A 
    [np.deg2rad(0), np.deg2rad(175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],       # B 
    [np.deg2rad(175), np.deg2rad(-175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # C 
    [np.deg2rad(0), np.deg2rad(-175), np.deg2rad(175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # D 
    [np.deg2rad(175), np.deg2rad(0), np.deg2rad(-175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # E 
    [np.deg2rad(0), np.deg2rad(0), np.deg2rad(-175), np.deg2rad(175), np.deg2rad(0), np.deg2rad(0)],    # F 
    [np.deg2rad(175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(-175), np.deg2rad(0), np.deg2rad(0)],    # G 
    [np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(-175), np.deg2rad(175), np.deg2rad(0)],    # H 
    [np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(-175), np.deg2rad(0)],      # I
])
