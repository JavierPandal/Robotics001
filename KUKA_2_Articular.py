...
T = np.array([
  ...
  [np.deg2rad(-170), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],        # A 
    [np.deg2rad(0), np.deg2rad(-195), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],       # B 
    [np.deg2rad(170), np.deg2rad(-175), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # C 
    [np.deg2rad(0), np.deg2rad(40), np.deg2rad(115), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # D 
    [np.deg2rad(170), np.deg2rad(0), np.deg2rad(-145), np.deg2rad(0), np.deg2rad(0), np.deg2rad(0)],    # E 
    [np.deg2rad(0), np.deg2rad(0), np.deg2rad(-145), np.deg2rad(185), np.deg2rad(0), np.deg2rad(0)],    # F 
